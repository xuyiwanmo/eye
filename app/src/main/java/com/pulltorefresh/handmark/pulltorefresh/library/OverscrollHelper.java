...
public final class OverscrollHelper {
	 ...
	 */
	public static void overScrollBy(final com.pulltorefresh.handmark.pulltorefresh.library.PullToRefreshBase<?> view, final int deltaX, final int scrollX,
	...
	public static void overScrollBy(final com.pulltorefresh.handmark.pulltorefresh.library.PullToRefreshBase<?> view, final int deltaX, final int scrollX,
		...
		if (view.isPullToRefreshOverScrollEnabled() && !view.isRefreshing()) {
			...
			if (mode.permitsPullToRefresh() && !isTouchEvent && deltaValue != 0) {
				...
				if (com.pulltorefresh.handmark.pulltorefresh.library.PullToRefreshBase.DEBUG) {
