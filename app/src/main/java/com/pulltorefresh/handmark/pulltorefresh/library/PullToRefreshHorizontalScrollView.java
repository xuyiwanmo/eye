...
public class PullToRefreshHorizontalScrollView extends com.pulltorefresh.handmark.pulltorefresh.library.PullToRefreshBase<HorizontalScrollView> {
	...
	final class InternalHorizontalScrollViewSDK9 extends HorizontalScrollView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
			...
			com.pulltorefresh.handmark.pulltorefresh.library.OverscrollHelper.overScrollBy(PullToRefreshHorizontalScrollView.this, deltaX, scrollX, deltaY, scrollY,
