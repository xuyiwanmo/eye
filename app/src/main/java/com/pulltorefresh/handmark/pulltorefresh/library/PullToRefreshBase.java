...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements com.pulltorefresh.handmark.pulltorefresh.library.IPullToRefresh<T> {
	...
	private com.pulltorefresh.handmark.pulltorefresh.library.internal.LoadingLayout mHeaderLayout;
	private com.pulltorefresh.handmark.pulltorefresh.library.internal.LoadingLayout mFooterLayout;
	...
	@Override
	public final com.pulltorefresh.handmark.pulltorefresh.library.ILoadingLayout getLoadingLayoutProxy() {
		return getLoadingLayoutProxy(true, true);
	}

	@Override
	public final com.pulltorefresh.handmark.pulltorefresh.library.ILoadingLayout getLoadingLayoutProxy(boolean includeStart, boolean includeEnd) {
	...
	public final boolean isPullToRefreshOverScrollEnabled() {
		return VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD && mOverScrollEnabled
				&& com.pulltorefresh.handmark.pulltorefresh.library.OverscrollHelper.isAndroidOverScrollEnabled(mRefreshableView);
	}
	...
	protected com.pulltorefresh.handmark.pulltorefresh.library.internal.LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs) {
		com.pulltorefresh.handmark.pulltorefresh.library.internal.LoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout(context, mode,
	 ...
	 */
	protected com.pulltorefresh.handmark.pulltorefresh.library.LoadingLayoutProxy createLoadingLayoutProxy(final boolean includeStart, final boolean includeEnd) {
		com.pulltorefresh.handmark.pulltorefresh.library.LoadingLayoutProxy proxy = new com.pulltorefresh.handmark.pulltorefresh.library.LoadingLayoutProxy();
	...
	protected final com.pulltorefresh.handmark.pulltorefresh.library.internal.LoadingLayout getFooterLayout() {
	...
	protected final com.pulltorefresh.handmark.pulltorefresh.library.internal.LoadingLayout getHeaderLayout() {
	...
	protected final void setHeaderScroll(int value) {
		...
		if (USE_HW_LAYERS) {
			 ...
			 */
			com.pulltorefresh.handmark.pulltorefresh.library.internal.ViewCompat.setLayerType(mRefreshableViewWrapper, value != 0 ? View.LAYER_TYPE_HARDWARE
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
			...
			com.pulltorefresh.handmark.pulltorefresh.library.internal.Utils.warnDeprecation("ptrAdapterViewBackground", "ptrRefreshableViewBackground");
	...
	public static enum AnimationStyle {
		...
		com.pulltorefresh.handmark.pulltorefresh.library.internal.LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				case ROTATE:
				default:
					return new com.pulltorefresh.handmark.pulltorefresh.library.internal.RotateLoadingLayout(context, mode, scrollDirection, attrs);
				case FLIP:
					return new com.pulltorefresh.handmark.pulltorefresh.library.internal.FlipLoadingLayout(context, mode, scrollDirection, attrs);
			}
		}
	}
	...
	public static enum Mode {
		...
		// The modeInt values need to match those from pull_attrs.xml
		Mode(int modeInt) {
			mIntValue = modeInt;
		}
	 ...
	 * {@link com.pulltorefresh.handmark.pulltorefresh.library.PullToRefreshAdapterViewBase#setOnLastItemVisibleListener}.
	 * 
	 * @author Chris Banes
	 */
	 ...
	 * (such as sounds). See (
	 * {@link com.pulltorefresh.handmark.pulltorefresh.library.PullToRefreshAdapterViewBase#setOnPullEventListener}.
	 * 
	 * @author Chris Banes
	 */
	...
	final class SmoothScrollRunnable implements Runnable {
		...
		public void run() {
			...
			/**
			 * Only set mStartTime if this is the first openDate we're starting,
			...
			if (mContinueRunning && mScrollToY != mCurrentY) {
				com.pulltorefresh.handmark.pulltorefresh.library.internal.ViewCompat.postOnAnimation(PullToRefreshBase.this, this);
			} else {
				if (null != mListener) {
