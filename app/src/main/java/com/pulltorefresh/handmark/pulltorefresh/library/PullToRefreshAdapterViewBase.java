...
import com.pulltorefresh.handmark.pulltorefresh.library.internal.IndicatorLayout;
import com.sg.eyedoctor.R;

public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends com.pulltorefresh.handmark.pulltorefresh.library.PullToRefreshBase<T> implements
		OnScrollListener {
	...
	private com.pulltorefresh.handmark.pulltorefresh.library.internal.IndicatorLayout mIndicatorIvTop;
	 ...
	 * {@link com.pulltorefresh.handmark.pulltorefresh.library.PullToRefreshBase#isPullToRefreshOverScrollEnabled()
	...
	/**
	 * Pass-through method for {@link com.pulltorefresh.handmark.pulltorefresh.library.PullToRefreshBase#getRefreshableView()
	 * getRefreshableView()}.
	...
	private void addIndicatorViews() {
		...
		if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
			...
			mIndicatorIvTop = new com.pulltorefresh.handmark.pulltorefresh.library.internal.IndicatorLayout(getContext(), Mode.PULL_FROM_START);
		...
		if (mode.showFooterLoadingLayout() && null == mIndicatorIvBottom) {
			// If the mode can pull down, and we don't have one set already
			mIndicatorIvBottom = new com.pulltorefresh.handmark.pulltorefresh.library.internal.IndicatorLayout(getContext(), Mode.PULL_FROM_END);
			FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
					ViewGroup.LayoutParams.WRAP_CONTENT);
			params.rightMargin = getResources().getDimensionPixelSize(R.dimen.indicator_right_padding);
