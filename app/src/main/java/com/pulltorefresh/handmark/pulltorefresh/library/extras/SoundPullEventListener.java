...
public class SoundPullEventListener<V extends View> implements com.pulltorefresh.handmark.pulltorefresh.library.PullToRefreshBase.OnPullEventListener<V> {
	...
	@Override
	public final void onPullEvent(com.pulltorefresh.handmark.pulltorefresh.library.PullToRefreshBase<V> refreshView, State event, Mode direction) {
