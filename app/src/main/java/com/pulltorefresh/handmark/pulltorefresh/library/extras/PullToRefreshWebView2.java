 ...
 *******************************************************************************/
package com.pulltorefresh.handmark.pulltorefresh.library.extras;
...
/**
 * An advanced version of {@link com.pulltorefresh.handmark.pulltorefresh.library.PullToRefreshWebView} which delegates the
 ...
 * <p/>
 * <ul>
 * <li>{@link com.pulltorefresh.handmark.pulltorefresh.library.PullToRefreshWebView} doesn't work correctly because you're using
 ...
 * @author Chris Banes
 */
public class PullToRefreshWebView2 extends com.pulltorefresh.handmark.pulltorefresh.library.PullToRefreshWebView {
    ...
    protected WebView createRefreshableView(Context context, AttributeSet attrs) {
        ...
        // Need to add JS Interface so we can get the ShareResult back
    ...
    /**
     * Used for ShareResult from Javascript
     *
     * @author Chris Banes
     */
