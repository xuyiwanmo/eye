...
public class ActionSheetDialog {
    ...
    public ActionSheetDialog builder() {
        ...
        View view = LayoutInflater.from(context).inflate(
                R.layout.custom_view_actionsheet, null);
    ...
    private void setSheetItems() {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            if (size == 1) {
                if (showTitle) {
                    textView.setBackgroundResource(R.drawable.actionsheet_bottom_normal);
                } else {
                    textView.setBackgroundResource(R.drawable.actionsheet_single_normal);
                }
            } else {
                if (showTitle) {
                    if (i >= 1 && i < size) {
                        textView.setBackgroundResource(R.drawable.actionsheet_middle_normal);
                    } else {
                        textView.setBackgroundResource(R.drawable.actionsheet_bottom_normal);
                    }
                } else {
            ...
            // 字体颜色
            if (color == 0) {
                textView.setTextColor(mResource.getColor(R.color.actionbar_color));
            } else {
