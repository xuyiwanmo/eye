...
package com.sg.eyedoctor.common.view.banner;
...
public class CircleFlowIndicator extends View implements FlowIndicator,
	...
	public CircleFlowIndicator(Context context, AttributeSet attrs) {
		...
		// Retrieve the fade out openDate
	...
	/**
	 * Counts from 0 to the fade out openDate and animates the view away when
	 * reached
	 */
		...
		protected Void doInBackground(Void... arg0) {
			while (_run) {
				try {
					...
					// Check if we've reached the fade out openDate
