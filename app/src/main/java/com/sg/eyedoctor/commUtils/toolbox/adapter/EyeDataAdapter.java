 ...
 */
public class EyeDataAdapter extends CommAdapter<EyeNV> {
    public EyeDataAdapter(Context context, ArrayList<EyeNV> list, int layoutId) {
        super(context, list, layoutId);
    }

    @Override
    protected View convert(EyeNV baseData, View convertView, Context context, int position, int layoutId) {
