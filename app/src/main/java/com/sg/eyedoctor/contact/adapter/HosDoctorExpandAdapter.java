 ...
 */
public class HosDoctorExpandAdapter extends BaseExpandableListAdapter {
    Context mContext;
    ArrayList<Department> mGroupStrings;
    ArrayList<ArrayList<DepartDoctor>> mItems;
    GroupClick mGroupClick;

    public HosDoctorExpandAdapter(Context mContext, ArrayList<Department> mGroupStrings, ArrayList<ArrayList<DepartDoctor>> mItems) {
    ...
    public View getGroupView(final int groupPosition, final boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        viewHolder.mGroupNameText.setText(mGroupStrings.get(groupPosition).departName);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        DepartDoctor patient = (DepartDoctor) getChild(groupPosition, childPosition);
        ChildViewHolder viewHolder = null;
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.item_contact_dept_doctor, null);
     ...
     //   viewHolder.mHeadImg.setImageResource(R.drawable.ic_patient_head);
        ...
        viewHolder.mNameText.setText(patient.doctorName);
        viewHolder.mPhoneText.setText(patient.doctorPhone+"");
    ...
    public void setData(ArrayList<Department> mGroupStrings, ArrayList<ArrayList<DepartDoctor>> mItems) {
        this.mItems=mItems;
        this.mGroupStrings=mGroupStrings;
