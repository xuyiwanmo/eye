package com.netease.nim.common.activity;
...
import com.netease.nim.common.util.sys.ReflectionUtil;
...
public abstract class TActionBarActivity extends BaseActivity {
    ...
    protected void onDestroy() {
        ...
        LogUtils.i("activity: " + getClass().getSimpleName() + " onDestroy()");
        destroyed = true;
    }
