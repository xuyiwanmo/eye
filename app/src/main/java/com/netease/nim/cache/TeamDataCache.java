package com.netease.nim.cache;

import android.text.TextUtils;

import com.netease.nim.NimUIKit;
import com.netease.nim.UIKitLogTag;
...
public class TeamDataCache {
    ...
    public void buildCache() {
        ...
        LogUtils.i(UIKitLogTag.TEAM_CACHE, "build TeamDataCache completed, team count = " + teams.size());
    }
        ...
        NIMClient.getService(TeamService.class).queryTeam(teamId).setCallback(new RequestCallbackWrapper<Team>() {
            ...
            public void onResult(int code, Team t, Throwable exception) {
                ...
                if (code == ResponseCode.RES_SUCCESS) {
                    ...
                    success = false;
                    LogUtils.e(UIKitLogTag.TEAM_CACHE, "fetchTeamById failed, code=" + code);
                }

                if (exception != null) {
                    success = false;
                    LogUtils.e(UIKitLogTag.TEAM_CACHE, "fetchTeamById throw exception, e=" + exception.getMessage());
                }
        ...
        NIMClient.getService(TeamService.class).queryMemberList(teamId).setCallback(new RequestCallbackWrapper<List<TeamMember>>() {
            ...
            public void onResult(int code, final List<TeamMember> members, Throwable exception) {
                ...
                if (code == ResponseCode.RES_SUCCESS) {
                    ...
                    success = false;
                    LogUtils.e(UIKitLogTag.TEAM_CACHE, "fetchTeamMemberList failed, code=" + code);
                }

                if (exception != null) {
                    success = false;
                    LogUtils.e(UIKitLogTag.TEAM_CACHE, "fetchTeamMemberList throw exception, e=" + exception.getMessage());
                }
        ...
        NIMClient.getService(TeamService.class).queryTeamMember(teamId, account).setCallback(new RequestCallbackWrapper<TeamMember>() {
            ...
            public void onResult(int code, TeamMember member, Throwable exception) {
                ...
                if (code == ResponseCode.RES_SUCCESS) {
                    ...
                    success = false;
                    LogUtils.e(UIKitLogTag.TEAM_CACHE, "fetchTeamMember failed, code=" + code);
                }

                if (exception != null) {
                    success = false;
                    LogUtils.e(UIKitLogTag.TEAM_CACHE, "fetchTeamMember throw exception, e=" + exception.getMessage());
                }
