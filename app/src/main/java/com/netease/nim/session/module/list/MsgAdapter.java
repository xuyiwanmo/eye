...
public class MsgAdapter extends TAdapter<IMMessage> {
    ...
    public MsgAdapter(Context context, List<IMMessage> items, TAdapterDelegate delegate, SessionCustomization customization) {
        super(context, items, delegate,customization);
