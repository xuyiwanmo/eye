...
import com.netease.nim.common.media.picker.activity.PreviewImageFromCameraActivity;
import com.netease.nim.common.ui.media.ImageUtil;
import com.netease.nim.common.util.file.AttachmentStore;
...
import com.netease.nim.session.helper.SendImageHelper;
...
public abstract class PickImageAction extends BaseAction {
    ...
    protected PickImageAction(int iconResId, int titleId, boolean multiSelect,SessionCustomization customization) {
        super(iconResId, titleId);
        this.multiSelect = multiSelect;
