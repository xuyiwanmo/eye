...
public class WheelView extends View {
    ...
    private static final float SCALECONTENT = 0.6F;//非中间文字则用此控制高度，压扁形成3d错觉
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if(attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.pickview_wheelview,0,0);
            mGravity = a.getInt(R.styleable.pickview_wheelview_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.pickview_wheelview_textColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.pickview_wheelview_textColorCenter,textColorCenter);
            dividerColor = a.getColor(R.styleable.pickview_wheelview_dividerColor,dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.pickview_wheelview_pickview_textSize,textSize);
        }
