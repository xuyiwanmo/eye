...
public class WheelTime {
    ...
    public void setPicker(int year, int month, int day, int h, int m) {
        ...
        switch (type) {
            case MORNING_HOURS_MINS:
                wv_hours.setAdapter(new NumericWheelAdapter(0, 11));
                wv_hours.setCurrentItem(0);
                break;
            case AFTERNOON_HOURS_MINS:
                wv_hours.setAdapter(new NumericWheelAdapter(12, 23));
                wv_hours.setCurrentItem(12);
                break;
        }
    ...
    public String getTime() {
        ...
        if(type==Type.AFTERNOON_HOURS_MINS){
            hours=(12+wv_hours.getCurrentItem())+"";
        }
